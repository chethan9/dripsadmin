...
class _EditMemberWidgetState extends State<EditMemberWidget> {
  ...
  void initState() {
    ...
    _model.nameController1 ??=
        TextEditingController(text: widget.memberRef?.orderNum?.toString());
    _model.nameFocusNode1 ??= FocusNode();

    _model.nameController2 ??=
        TextEditingController(text: widget.memberRef?.title);
    _model.nameFocusNode2 ??= FocusNode();

    _model.orderNumberController ??=
        TextEditingController(text: widget.memberRef?.subtitle);
    _model.orderNumberFocusNode ??= FocusNode();

    _model.descriptionController ??=
        TextEditingController(text: widget.memberRef?.bio);
    _model.descriptionFocusNode ??= FocusNode();

    _model.nameController3 ??=
        TextEditingController(text: widget.memberRef?.webLink);
    _model.nameFocusNode3 ??= FocusNode();

    _model.nameController4 ??=
        TextEditingController(text: widget.memberRef?.fbLink);
    _model.nameFocusNode4 ??= FocusNode();

    _model.nameController5 ??=
        TextEditingController(text: widget.memberRef?.instaLink);
    _model.nameFocusNode5 ??= FocusNode();

    _model.nameController6 ??=
        TextEditingController(text: widget.memberRef?.inLink);
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              if (widget.memberRef?.image != null &&
                                  widget.memberRef?.image != '')
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                            ...
                                            await showDialog<bool>(
                                                  ...
                                                  builder:
                                                    ...
                                                    return WebViewAware(
                                                      child: AlertDialog(
                                                        content: Text(
                                                            'Do you want to remove main image?'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await widget.memberRef!.reference
                        ...
                        orderNum: int.tryParse(_model.nameController1.text),
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            '${widget.memberRef?.memberType} updated successfuly',
                            style: TextStyle(
