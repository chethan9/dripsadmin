...
import 'batch_course_list_proces_model.dart';
export 'batch_course_list_proces_model.dart';

class BatchCourseListProcesWidget extends StatefulWidget {
  const BatchCourseListProcesWidget({
    super.key,
  ...
  @override
  State<BatchCourseListProcesWidget> createState() =>
      _BatchCourseListProcesWidgetState();
}

class _BatchCourseListProcesWidgetState
    extends State<BatchCourseListProcesWidget> {
  late BatchCourseListProcesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BatchCourseListProcesModel());
