...
class _TranslationPollFORMWidgetState extends State<TranslationPollFORMWidget> {
  ...
  void initState() {
    ...
    _model.inputController6 ??= TextEditingController();
