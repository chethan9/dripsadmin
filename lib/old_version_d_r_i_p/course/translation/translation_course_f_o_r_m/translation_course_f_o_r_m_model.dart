...
class TranslationCourseFORMModel
  ...
  TextEditingController? inputController19;
  String? Function(BuildContext, String?)? inputController19Validator;
  // State field(s) for input widget.
  FocusNode? inputFocusNode20;
  TextEditingController? inputController20;
  String? Function(BuildContext, String?)? inputController20Validator;
  // State field(s) for input widget.
  FocusNode? inputFocusNode21;
  TextEditingController? inputController21;
  String? Function(BuildContext, String?)? inputController21Validator;
  // State field(s) for input widget.
  FocusNode? inputFocusNode22;
  TextEditingController? inputController22;
  String? Function(BuildContext, String?)? inputController22Validator;
  // State field(s) for input widget.
  FocusNode? inputFocusNode23;
  TextEditingController? inputController23;
  String? Function(BuildContext, String?)? inputController23Validator;
  // State field(s) for input widget.
  FocusNode? inputFocusNode24;
  TextEditingController? inputController24;
  String? Function(BuildContext, String?)? inputController24Validator;
  // State field(s) for input widget.
  FocusNode? inputFocusNode25;
  TextEditingController? inputController25;
  String? Function(BuildContext, String?)? inputController25Validator;
  ...
  void dispose() {
    ...
    inputController19?.dispose();

    inputFocusNode20?.dispose();
    inputController20?.dispose();

    inputFocusNode21?.dispose();
    inputController21?.dispose();

    inputFocusNode22?.dispose();
    inputController22?.dispose();

    inputFocusNode23?.dispose();
    inputController23?.dispose();

    inputFocusNode24?.dispose();
    inputController24?.dispose();

    inputFocusNode25?.dispose();
    inputController25?.dispose();
