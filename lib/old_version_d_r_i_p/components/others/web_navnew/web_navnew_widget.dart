...
import 'web_navnew_model.dart';
export 'web_navnew_model.dart';

class WebNavnewWidget extends StatefulWidget {
  const WebNavnewWidget({
    super.key,
    this.colorBgOne,
    this.colorBgTwo,
    this.colorBgThree,
  ...
  @override
  State<WebNavnewWidget> createState() => _WebNavnewWidgetState();
}

class _WebNavnewWidgetState extends State<WebNavnewWidget> {
  late WebNavnewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebNavnewModel());
