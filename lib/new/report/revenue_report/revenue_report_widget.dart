...
import 'revenue_report_model.dart';
export 'revenue_report_model.dart';
...
class _RevenueReportWidgetState extends State<RevenueReportWidget> {
  late RevenueReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RevenueReportModel());
