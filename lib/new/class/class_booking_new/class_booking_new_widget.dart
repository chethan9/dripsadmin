...
import 'class_booking_new_model.dart';
export 'class_booking_new_model.dart';

class ClassBookingNewWidget extends StatefulWidget {
  const ClassBookingNewWidget({
    super.key,
    this.courseRef,
  ...
  @override
  State<ClassBookingNewWidget> createState() => _ClassBookingNewWidgetState();
}

class _ClassBookingNewWidgetState extends State<ClassBookingNewWidget> {
  late ClassBookingNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClassBookingNewModel());
